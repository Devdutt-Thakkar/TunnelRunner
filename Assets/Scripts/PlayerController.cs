...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameObject.transform.position.x < -162)
        {
            print("This is being detected");
            gameObject.transform.position = new Vector3(113.5f, gameObject.transform.position.y, gameObject.transform.position.z);
        }
